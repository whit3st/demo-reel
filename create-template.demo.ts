...
export default defineConfig({
  ...
  preSteps: [
    ...
    { action: "type", selector: { strategy: "id", value: "slug" }, text: "demo-vid3", clear: true },
    ...
    { action: "wait", ms: 1500 },
    { action: "click", selector: { strategy: "href", value: "/tenants/demo-vid3" } },
    { action: "wait", ms: 1000 },
  ],
  ...
  steps: [
    ...
    { action: "click", selector: { strategy: "href", value: "/tenants/demo-vid3/templates" }, delayAfterMs: 1500 },

    // Scene 2: Create template
    { action: "click", selector: { strategy: "href", value: "/tenants/demo-vid3/templates/new" }, delayAfterMs: 500 },
