...
export const scriptSceneSchema = z.object({
  ...
  stepIndex: z
    ...
    .min(0)
    .optional()
    .describe("Step index where this scene starts when rendered"),
  sourceSceneIndex: z
    .number()
    .int()
    .min(0)
    .optional()
    .describe("Stable source index for this scene across timing/audio artifacts"),
});
...
export const scriptConfigSchema = z.object({
  ...
  output: z
    .object({
      ...
      resolution: z.enum(["HD", "FHD", "2K", "4K"]).default("FHD").describe("Video resolution"),
    })
    .optional()
