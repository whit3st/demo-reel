...
export default defineConfig({
  ...
  preSteps: [
    ...
    { action: "type", selector: { strategy: "id", value: "slug" }, text: "demo-vid7", clear: true },
    ...
    { action: "wait", ms: 1500 },
    { action: "click", selector: { strategy: "href", value: "/tenants/demo-vid7" } },
    { action: "wait", ms: 1000 },
  ],
  ...
  steps: [
    ...
    { action: "click", selector: { strategy: "href", value: "/tenants/demo-vid7/templates" }, delayAfterMs: 1500 },

    // Scene 2: Create template
    { action: "click", selector: { strategy: "href", value: "/tenants/demo-vid7/templates/new" }, delayAfterMs: 500 },
